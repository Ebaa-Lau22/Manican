...
import 'package:manican/features/authentication/data/datasources/user_local_data_source.dart';
import 'package:manican/features/authentication/data/datasources/user_remote_data_source.dart';
import 'package:manican/features/authentication/data/repositories/user_repository_impl.dart';
import 'package:manican/features/authentication/domain/repositories/user_repository.dart';
import 'package:manican/features/authentication/domain/usecases/login_usecase.dart';
import 'package:manican/features/authentication/presentation/bloc/cubit.dart';
import 'package:manican/features/before_after/data/datasources/before_after_remote_data_source.dart';
import 'package:manican/features/before_after/data/repositories/before_after_repository_impl.dart';
import 'package:manican/features/before_after/domain/usecases/before_after_usecase.dart';
import 'package:manican/features/before_after/presentation/bloc/cubit/before_after_cubit.dart';
import 'package:manican/features/before_after/presentation/bloc/cubit/before_after_state.dart';
import 'package:manican/features/booking/domain/usecases/booking_usecase.dart';
import 'package:manican/features/booking/presentation/bloc/cubit/booking_bolc_cubit.dart';
import 'package:manican/features/booking/presentation/bloc/cubit/booking_bolc_state.dart';
import 'package:manican/features/bookings/data/datasources/booking_remote_data_source.dart';
import 'package:manican/features/bookings/data/repositories/booking_repositroy_impl.dart';
import 'package:manican/features/bookings/domain/usecases/accept_booking_use_case.dart';
import 'package:manican/features/bookings/domain/usecases/decline_booking_use_case.dart';
import 'package:manican/features/bookings/domain/usecases/get_all_archived_bookings.dart';
import 'package:manican/features/bookings/domain/usecases/get_all_current_bookings_use_case.dart';
import 'package:manican/features/bookings/domain/usecases/download_file_bookings_use_case.dart';
import 'package:manican/features/bookings/presentation/bloc/cubit.dart';
import 'package:manican/features/branches/data/datasources/branch_remote_data_source.dart';
import 'package:manican/features/branches/domain/usecases/branches_usecase.dart';
import 'package:manican/features/branches/presentation/bloc/branches_bloc/branches_bloc.dart';
import 'package:manican/features/branches/presentation/bloc/branches_bloc/branches_state.dart';
import 'package:manican/features/clients/data/datasources/client_remote_data_source.dart';
import 'package:manican/features/clients/data/repositories/client_repositroy_impl.dart';
import 'package:manican/features/clients/domain/repositories/clients_repository.dart';
import 'package:manican/features/clients/domain/usecases/accept_booking_use_case.dart';
import 'package:manican/features/clients/domain/usecases/add_employee_use_case.dart';
import 'package:manican/features/clients/domain/usecases/decline_booking_use_case.dart';
import 'package:manican/features/clients/domain/usecases/delete_employee_use_case.dart';
import 'package:manican/features/clients/domain/usecases/edit_employee_use_case.dart';
import 'package:manican/features/clients/domain/usecases/get_all_employees_use_case.dart';
import 'package:manican/features/clients/domain/usecases/get_archived_client_bookings_use_case.dart';
import 'package:manican/features/clients/domain/usecases/get_booking_percentage_use_case.dart';
import 'package:manican/features/clients/domain/usecases/get_current_client_bookings_use_case.dart';
import 'package:manican/features/clients/presentation/bloc/cubit.dart';
import 'package:manican/features/complaints/data/datasources/complaints_remote_data_source.dart';
import 'package:manican/features/complaints/data/repositories/complaint_repository_impl.dart';
import 'package:manican/features/complaints/domain/repositories/complaints_repository.dart';
import 'package:manican/features/complaints/domain/usecases/delete_complaint.dart';
import 'package:manican/features/complaints/domain/usecases/get_all_complaints.dart';
import 'package:manican/features/complaints/presentation/bloc/cubit.dart';
import 'package:manican/features/employees/data/datasources/employee_remote_data_source.dart';
import 'package:manican/features/employees/data/repositories/employee_repository_impl.dart';
import 'package:manican/features/employees/domain/repositories/employee_repository.dart';
import 'package:manican/features/employees/domain/usecases/add_employee_use_case.dart';
import 'package:manican/features/employees/domain/usecases/delete_employee_use_case.dart';
import 'package:manican/features/employees/domain/usecases/edit_employee_use_case.dart';
import 'package:manican/features/employees/domain/usecases/get_all_employees_use_case.dart';
import 'package:manican/features/employees/domain/usecases/get_all_services_use_case.dart';
import 'package:manican/features/employees/domain/usecases/get_employee_attendance_use_case.dart';
import 'package:manican/features/employees/domain/usecases/upload_file_attendance_use_case.dart';
import 'package:manican/features/employees/presentation/bloc/cubit.dart';
import 'package:manican/features/offers/data/datasources/offer_remote_data_source.dart';
import 'package:manican/features/offers/data/repositories/offers_repository_impl.dart';
import 'package:manican/features/offers/domain/usecases/offers_usecase.dart';
import 'package:manican/features/offers/presentation/bloc/offer_bloc/offer_bloc.dart';
import 'package:manican/features/offers/presentation/bloc/offer_bloc/offer_state.dart';
import 'package:manican/features/services/data/datasources/services_remote_data_source.dart';
import 'package:manican/features/services/data/repositories/services_repository_impl.dart';
import 'package:manican/features/services/domain/usecases/services_usecase.dart';
import 'package:manican/features/services/presentation/bloc/cubit/service_bolc_cubit.dart';
import 'package:manican/features/services/presentation/bloc/cubit/service_bolc_state.dart';
import 'package:manican/features/statistic/data/datasources/statistics_remote_data_source.dart';
import 'package:manican/features/statistic/data/repositories/statistics_repository_impl.dart';
import 'package:manican/features/statistic/domain/usecases/statistics_usecase.dart';
import 'package:manican/features/statistic/presentation/bloc/statistic_bloc/statistic_bloc.dart';
import 'package:manican/features/statistic/presentation/bloc/statistic_bloc/statistic_state.dart';
